...
class RecurringPayment extends DataObject
{
    ...
    public function getLatestPayment($successonly = true)
    {
        if ($successonly) {
    ...
    public function generateFirstPayment()
    {
        $payment = new Payment();
    ...
    public function generateNextPaymentFrom($latest)
    {
