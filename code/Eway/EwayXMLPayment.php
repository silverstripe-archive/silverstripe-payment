...
class EwayXMLPayment extends Payment
{
    ...
    public static function set_customer_id($id)
    {
        self::$customer_id = $id;
    }
    ...
    public function getPaymentFormFields()
    {
        ...
        if (self::$test_mode) {
            $fields->push(new ReadonlyField('Eway_CreditCardNumber', 'Credit Card Number :', self::$test_credit_card_number));
        } else {
            $fields->push(new CreditCardField('Eway_CreditCardNumber', 'Credit Card Number :'));
        }
        ...
        if (self::$cvn_mode) {
            $fields->push(new TextField('Eway_CreditCardCVN', 'Credit Card CVN : (3 or 4 digits)', '', 4));
        }
        return $fields;
    }
