...
class PaystationHostedPayment extends Payment
{
    ...
    public static function set_merchant_ref($merchant_ref)
    {
    ...
    public function PaystationForm()
    {
        ...
        if (self::$merchant_ref) {
            $url .= '&merchant_ref=' . self::$merchant_ref;
        }
...
class PaystationHostedPayment_Handler extends Controller
{
    ...
    public static $URLSegment = 'paystation';
        ...
        if (isset($_REQUEST['ec'])) {
            if (isset($_REQUEST['ms'])) {
                if ($payment = DataObject::get_by_id('PaystationHostedPayment', $_REQUEST['ms'])) {
                    ...
                    user_error('There is no any Paystation hosted payment which ID is #' . $_REQUEST['ms'], E_USER_ERROR);
                }
            } else {
